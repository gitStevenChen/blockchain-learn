...
contract ComptrollerG1 is ComptrollerV1Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
     ...
     */
    function mintVerify(address cToken, address minter, uint mintAmount, uint mintTokens) override external {
     ...
     */
    function liquidateCalculateSeizeTokens(address cTokenBorrowed, address cTokenCollateral, uint repayAmount) override external view returns (uint, uint) {
